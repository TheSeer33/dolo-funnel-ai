  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-sm">
      <div className="bg-zinc-900 border border-white/10 rounded-2xl p-8 w-full max-w-md relative">
        ...
        <p className="text-white/50 text-sm mb-6">{mode === 'signup' ? 'Start building funnels in 60 seconds' : 'Sign in to your dashboard'}</p>

        <button onClick={signInWithGoogle} className="w-full flex items-center justify-center gap-3 border border-white/20 text-white py-3 rounded-xl hover:border-white/40 transition-colors mb-4 font-medium text-sm">
        ...
        <p className="text-center text-white/40 text-sm mt-4">
          ...
          <button onClick={onSwitch} className="text-violet-400 hover:text-violet-300 transition-colors">
